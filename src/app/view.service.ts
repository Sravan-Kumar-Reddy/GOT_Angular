...
export class ViewService {
    ...
    public getAllCharacters(): any {//Function to get all characters in the JSON file
        return this.getAllCharacters;
    }
    public getAllHouses(): any {//Function to get all Houses in the JSON file
        return this.getAllHouses;
    }
    public getAllBooks(): any {//Function to get all Books in the JSON file
    ...
    public getSingleView(currentObject): any {//Function to get the current character/book/house
        for (let i of this.allCharacters) {
            if (i.name == currentObject) {
                this.currentObject = i;
            } else if (i.url == currentObject) {
                this.currentObject = i;//Working Ended Here
                //console.log("current View:" + currentObject);
            }
        }
    }
}
